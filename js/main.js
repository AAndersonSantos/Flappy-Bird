...
const audio = {
    game: new Audio('audio/happy_adveture.mp3'),
...
function Passaro(alturaJogo) {
    voando = false
    document.querySelector('.menugame').style.display = 'initial'
...
function FlappyBird() {
    ...
    const barreiras = new Barreiras(altura, largura, 270, 400, () => progresso.atualizarPontos(++pontos))
